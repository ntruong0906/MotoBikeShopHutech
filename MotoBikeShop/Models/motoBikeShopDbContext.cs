...
public partial class motoBikeShopDbContext : DbContext
{
    public motoBikeShopDbContext()
    {
    }

    public motoBikeShopDbContext(DbContextOptions<motoBikeShopDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=LAPTOP-S31L0IIU;Initial Catalog=MotoBikeShop;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
...
// Thêm 8 hàng hóa khác tương tự ở đây
);
        ...
        new Loai { MaLoai = 1, TenLoai = "Xe Côn", TenLoaiAlias = "xe-con", MoTa = "Xe này để đua ", Hinh = "xecon.png" },
         new Loai { MaLoai = 2, TenLoai = "Xe ga", TenLoaiAlias = "xe-ga", MoTa = "Xe này để tán gái", Hinh = "xega.png" },
         new Loai { MaLoai = 3, TenLoai = "Xe số", TenLoaiAlias = "xe-so", MoTa = "Xe này để đi làm", Hinh = "xeso.png" }
    );
