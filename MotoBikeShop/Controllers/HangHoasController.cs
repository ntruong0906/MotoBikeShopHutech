...
namespace MotoBikeShop.Controllers
{
    public class HangHoasController : Controller
    {
        ...
        public HangHoasController(motoBikeShopDbContext context)
        {
            _context = context;
        }
        ...
        {
            var motoBikeShopDbContext = _context.HangHoas.Include(h => h.MaLoaiNavigation).Include(h => h.MaNccNavigation);
            return View(await motoBikeShopDbContext.ToListAsync());
        }
