    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 400000.0, 9999999.0, "xecon.png", 1, "NCC002", "xe này cực đẹp", "VND", new DateTime(2024, 3, 27, 17, 32, 42, 147, DateTimeKind.Local).AddTicks(1271), 99, "exciter", "Exciter" },
                    { 2, 300000.0, 9999999.0, "xega.png", 2, "NCC001", "xe này cực đẹp", "VND", new DateTime(2024, 3, 27, 17, 32, 42, 147, DateTimeKind.Local).AddTicks(1306), 99, "vario", "Vario" },
                    { 3, 100000.0, 9999999.0, "xeso.png", 3, "NCC003", "xe này cực đẹp", "VND", new DateTime(2024, 3, 27, 17, 32, 42, 147, DateTimeKind.Local).AddTicks(1307), 99, "wave-rsx", "Wave RSX" }
                });
        }
