...
{
    [DbContext(typeof(motoBikeShopDbContext))]
    partial class motoBikeShopDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MotoBikeShop.Data.BanBe", b =>
                {
                    b.Property<int>("MaBb")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MotoBikeShop.Data.ChuDe", b =>
                {
                    b.Property<int>("MaCd")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MotoBikeShop.Data.GopY", b =>
                {
            ...
            modelBuilder.Entity("MotoBikeShop.Data.HangHoa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MoTa = "xe này cực đẹp",
                            MoTaDonVi = "VND",
                            NgaySx = new DateTime(2024, 3, 25, 20, 45, 41, 795, DateTimeKind.Local).AddTicks(9652),
                            SoLanXem = 99,
                            TenAlias = "exciter",
                            TenHh = "Exciter"
                        },
                        new
                        {
                            ...
                            MoTa = "xe này cực đẹp",
                            MoTaDonVi = "VND",
                            NgaySx = new DateTime(2024, 3, 25, 20, 45, 41, 795, DateTimeKind.Local).AddTicks(9668),
                            SoLanXem = 99,
                            TenAlias = "vario",
                            TenHh = "Vario"
                        },
                        new
                        {
                            ...
                            MoTa = "xe này cực đẹp",
                            MoTaDonVi = "VND",
                            NgaySx = new DateTime(2024, 3, 25, 20, 45, 41, 795, DateTimeKind.Local).AddTicks(9669),
                            SoLanXem = 99,
                            TenAlias = "wave-rsx",
                            TenHh = "Wave RSX"
                        });
            ...
            modelBuilder.Entity("MotoBikeShop.Data.HoiDap", b =>
                {
                    b.Property<int>("MaHd")
                        .HasColumnType("int")
                        .HasColumnName("MaHD");
            ...
            modelBuilder.Entity("MotoBikeShop.Data.KhachHang", b =>
                {
                    b.Property<string>("MaKh")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
            ...
            modelBuilder.Entity("MotoBikeShop.Data.NhanVien", b =>
                {
                    b.Property<string>("MaNv")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("MotoBikeShop.Data.PhanCong", b =>
                {
                    b.Property<int>("MaPc")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MotoBikeShop.Data.PhanQuyen", b =>
                {
                    b.Property<int>("MaPq")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MotoBikeShop.Data.PhongBan", b =>
                {
                    b.Property<string>("MaPb")
                        .HasMaxLength(7)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("MotoBikeShop.Data.TrangThai", b =>
                {
                    b.Property<int>("MaTrangThai")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MotoBikeShop.Data.TrangWeb", b =>
                {
                    b.Property<int>("MaTrang")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MotoBikeShop.Data.VChiTietHoaDon", b =>
                {
                    b.Property<double>("DonGia")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("MotoBikeShop.Data.BanBe", b =>
                {
                    b.HasOne("MotoBikeShop.Data.HangHoa", "MaHhNavigation")
                        .WithMany("BanBes")
                        .HasForeignKey("MaHh")
                    ...
                    b.HasOne("MotoBikeShop.Data.KhachHang", "MaKhNavigation")
                        .WithMany("BanBes")
                        .HasForeignKey("MaKh")
                        .IsRequired()
            ...
            modelBuilder.Entity("MotoBikeShop.Data.ChuDe", b =>
                {
                    b.HasOne("MotoBikeShop.Data.NhanVien", "MaNvNavigation")
                        .WithMany("ChuDes")
                        .HasForeignKey("MaNv")
                        .OnDelete(DeleteBehavior.Cascade)
            ...
            modelBuilder.Entity("MotoBikeShop.Data.GopY", b =>
                {
                    b.HasOne("MotoBikeShop.Data.ChuDe", "MaCdNavigation")
                        .WithMany("Gopies")
                        .HasForeignKey("MaCd")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("MotoBikeShop.Data.HoaDon", b =>
                {
                    ...
                    b.HasOne("MotoBikeShop.Data.TrangThai", "MaTrangThaiNavigation")
                        .WithMany("HoaDons")
            ...
            modelBuilder.Entity("MotoBikeShop.Data.PhanCong", b =>
                {
                    ...
                    b.HasOne("MotoBikeShop.Data.PhongBan", "MaPbNavigation")
                        .WithMany("PhanCongs")
                        .HasForeignKey("MaPb")
                        .IsRequired()
            ...
            modelBuilder.Entity("MotoBikeShop.Data.PhanQuyen", b =>
                {
                    ...
                    b.HasOne("MotoBikeShop.Data.TrangWeb", "MaTrangNavigation")
                        .WithMany("PhanQuyens")
